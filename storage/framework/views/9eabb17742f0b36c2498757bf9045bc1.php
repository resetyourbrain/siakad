                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="<?php echo e(URL::asset('build/images/users/user-dummy-img.jpg')); ?>" alt="Header Avatar">
...
<?php /**PATH /home/reset/LEARN/sistem-akademik/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>